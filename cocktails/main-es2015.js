...
class ApiService {
    ...
    getCategories() {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl}${this.apis.filters}`);
    }
    getCocktails(category) {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl}${this.apis.cocktails}${category}`);
    }
}
...
/* harmony import */ var _filter_filter_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./filter/filter.component */ "./src/app/filter/filter.component.ts");
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 4, vars: 0, consts: [[1, "page"], [1, "filter"], [1, "content"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _header_icon_icon_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./header/icon/icon.component */ "./src/app/header/icon/icon.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"],
        ...
        _header_icon_icon_component__WEBPACK_IMPORTED_MODULE_8__["IconComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _filter_filter_component__WEBPACK_IMPORTED_MODULE_6__["FilterComponent"],
                    _content_content_component__WEBPACK_IMPORTED_MODULE_7__["ContentComponent"],
                    _header_icon_icon_component__WEBPACK_IMPORTED_MODULE_8__["IconComponent"]
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                    _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
...
function ContentComponent_div_1_div_5_Template(rf, ctx) { if (rf & 1) {
    ...
    const cocktail_r3 = ctx.$implicit;
...
ContentComponent.ɵfac = function ContentComponent_Factory(t) { return new (t || ContentComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"])); };
ContentComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ContentComponent, selectors: [["app-content"]], decls: 2, vars: 1, consts: [[1, "content"], ["class", "category", 4, "ngFor", "ngForOf"], [1, "category"], [1, "divider"], [1, "grid"], ["class", "cocktail", 4, "ngFor", "ngForOf"], [1, "cocktail"], ["alt", "", 1, "thumb", 3, "src"], [1, "name"]], template: function ContentComponent_Template(rf, ctx) { if (rf & 1) {
...
class DataService {
    ...
    getData() {
        this.api.getCategories().subscribe(({ drinks }) => {
            ...
            this.allCategories.forEach(({ category }) => {
                this.api.getCocktails(category).subscribe(({ drinks }) => {
    ...
    selectCategories(categories) {
        this.selectedCategories = this.allCategories.filter(({ selected }) => {
...
DataService.ɵfac = function DataService_Factory(t) { return new (t || DataService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DataService, [{
    ...
    }], function () { return [{ type: _api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"] }]; }, { allCategories$: [{
...
function FilterComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function FilterComponent_div_1_Template_input_change_2_listener() { const f_r1 = ctx.$implicit; return f_r1.selected = !f_r1.selected; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
class FilterComponent {
    ...
    ngOnInit() {
        this.data.getData();
        this.data.allCategories$.subscribe((categories) => {
...
FilterComponent.ɵfac = function FilterComponent_Factory(t) { return new (t || FilterComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"])); };
FilterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FilterComponent, selectors: [["app-filter"]], decls: 4, vars: 1, consts: [[1, "filter"], ["class", "filter-item", 4, "ngFor", "ngForOf"], [1, "button", 3, "click"], [1, "filter-item"], [1, "label"], ["type", "checkbox", 1, "checkbox", 3, "checked", "change"], [1, "filter-title"]], template: function FilterComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, FilterComponent_div_1_Template, 5, 2, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "button", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function FilterComponent_Template_button_click_2_listener() { return ctx.apply(); });
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _icon_icon_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./icon/icon.component */ "./src/app/header/icon/icon.component.ts");
...
HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HeaderComponent, selectors: [["app-header"]], decls: 4, vars: 0, consts: [[1, "header"], [1, "title"], [1, "icon"]], template: function HeaderComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
module.exports = __webpack_require__(/*! D:\Projects\it-work-tests\Inmost\coctails\src\main.ts */"./src/main.ts");
